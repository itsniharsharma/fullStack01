...
import CollNavbar from '../CollNavbar.js';
import '../CollagewearCSS/Basic.css';
import '../CollagewearCSS/CartBag.css'
import OfferCarousalForBasic from '../CollagewearCSS/CollageWearImgs/BasicSampleCar.webp';
...
export default function Basics() {
  ...
  return (
    <div>
      ...
      <CollNavbar cartItems={cartItems} />
      ...
      <div className="container py-5">
        <div className="row">
          ...
          <div className="col-lg-6">
            ...
            <div className="d-flex gap-3 mb-4">
              <input type="number" className="form-control" defaultValue="1" style={{ maxWidth: '80px' }} />
              <button className="btn btn-dark" type="button" onClick={handleAddToCart}>Add to Cart</button>
            </div>
            <div>
              {/* <button className="btn btn-outline-secondary btn-sm" type="button">Add to Wishlist</button>
              <button className="btn btn-outline-secondary btn-sm" type="button">Compare</button> */}
                   ...
                   <div className="d-grid gap-2 col-6">
                     <button className="BasicBuyBtn01" type="button">Buy Now</button>
                   </div>
